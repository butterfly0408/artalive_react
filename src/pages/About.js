    ...
    <>
      ...
      <about className={`bg-${page_color}`}>
        ...
        <main>
          ...
          <Section margin='mb-0'>
            <div className={`card text-bg-dark text-center mx-auto my-4 border border-2 border-bright-${page_color}`}>
              <img src={elaine} alt="Elaine Marx, Founder of Art Alive Art School" />
            </div>
            <div className='d-flex w-75 flex-column justify-content-center'>
          ...
          <Section margin='mt-0' gap='3'>
            ...
            >
              <img src={studio_01} style={{ maxHeight: '30rem' }} />
            </div>
            <div className={`card text-bg-dark text-center mx-auto my-4 border border-2 border-bright-${page_color}`}
              style={{ height: 'fit-content' }}
            >
              <img src={studio_02} style={{ maxHeight: '30rem' }} />
            </div>
          </Section>

          <Section margin='0'>
            <h2 className={`font-custom text-bright-${page_color}`}>We would love to bring your Art Alive with you.</h2>
          </Section>
