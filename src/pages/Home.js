        ...
        <div className='BenefitsOfArt'>
          <div className='d-flex gap-3 justify-content-center mt-4 mb-4 mx-4'>
            ...
            <div className='w-50 d-flex flex-column justify-content-center'>
              <h2 className='font-custom'>The Benefits of Art</h2>
              <p>
        ...
        <div class='ArtClasses'>
          {/* Heading Card */}
            <div className='w-100 text-center mb-4'>
              <h1 className='font-custom'>Art Classes</h1>
            </div>
          <div className='d-flex gap-3 justify-content-center mt-4 mb-4 mx-4'>
            {/* Mediums Card */}
            <div className='card w-50 text-bg-dark text-center py-4'>
              <div className='card-body'>
                <h2 className='card-title font-custom'>Mediums</h2>
            ...
            <div className='card w-50 text-bg-dark text-center py-4'>
              <div className='card-body'>
                <h2 className='card-title font-custom'>Teachers</h2>
                <p className='card-text'>Art Alive has 9 teachers with various qualifications and years of experience.</p>
                <button className='btn border border-2 border-white text-white font-custom'>Meet Our Teachers</button>
              </div>
            </div>
            ...
            <div className='card w-50 text-bg-dark text-center py-4'>
              <div className='card-body'>
                <h2 className='card-title font-custom'>Availability & Class Times</h2>
                ...
                <div className='d-flex gap-3 justify-content-center'>
                  <button className='me-2 btn border border-2 border-white text-white font-custom'>Our Classes</button>
                  <button className='btn border border-2 border-white text-white font-custom'>Join Today</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class='ArtExhibition'>
          {/* Heading Card */}
            <div className='w-100 text-center mt-4'>
              <h1 className='font-custom'>Art Exhibition</h1>
            </div>
          ...
          <div className='w-75 mt-1 mx-auto text-center mb-2'>
            <button className='me-2 btn border border-2 border-black text-black font-custom'>Find out More</button>
          </div>
