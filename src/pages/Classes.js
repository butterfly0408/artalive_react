      ...
      <events className={`bg-${page_color}`}>
        ...
        <main>
          <div className={`bg-${page_color}`}>
            ...
            <div className='OurClasses'>
              <div className='d-flex gap-3 justify-content-center m-4'>
                ...
                <div className='w-50 d-flex flex-column justify-content-center'>
                  <h2 className='font-custom'>Our Classes</h2>
                  ...
                  <div>
                    <button className='btn border border-2 border-black font-custom'>Join Now</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className='ClassTimesAndFees'>
              <div className='d-flex gap-3 justify-content-center m-4'>
                {/* Images */}
                <div className='card w-25 text-bg-dark text-center mx-auto my-4'>
                ...
                {/* Content */}
                <div className='w-50 d-flex flex-column justify-content-center'>
                  <h2 className='font-custom'>Class Times</h2>
                  <ul>
                  ...
                  <h2 className='font-custom'>Class Fees</h2>
                  <ul>
